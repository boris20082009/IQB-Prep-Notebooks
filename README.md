...
* In the section for Git Repository URL, type in the URL for your app's GitHub repo.
  * For a public GitHub repository, you can directly paste in the https URL from the clipboard: 
